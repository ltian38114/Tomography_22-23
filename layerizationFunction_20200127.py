...
df = pd.read_csv('C:/Users/Li/Desktop/git/tomographyscripts_lchan/particle_coords.csv', header=None) 
...
#%%
store100 = measureDistFromPlane('C:/Users/Li/Desktop/git/tomographyscripts_lchan/particle_coords.csv','cursor_temp_100_3.csv') #needs to be reselected in MAT
#%%
...
#%%
store010 = measureDistFromPlane('C:/Users/Li/Desktop/git/tomographyscripts_lchan/particle_coords.csv','cursor_temp_010_3.csv')
#%%
...
plt.show()
#%%
store001 = measureDistFromPlane('C:/Users/Li/Desktop/git/tomographyscripts_lchan/particle_coords.csv','cursor_temp_001_3.csv', z_buffer =-500) #needs to be reselected in MAT
#%%

comLayer[:,6] = layerClustering(defaultPixelSize, 15, 6.5, -751, store001)
...
plt.show()
#%%
measureDistFromPlane('C:/Users/Li/Desktop/git/tomographyscripts_lchan/particle_coords.csv','cursor_temp_110_3.csv') #needs to be reselected in MAT
#%%
