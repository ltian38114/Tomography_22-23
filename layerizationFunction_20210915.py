...
df = pd.read_csv('C:/Users/Li/Desktop/git/tomographyscripts_lchan/particle_final_edit_1k.csv', header=None) 
...
comLayer[:,3] = dfnp[:,2]
#%%
store100 = measureDistFromPlane('C:/Users/Li/Desktop/git/tomographyscripts_lchan/particle_final_edit_1k.csv','cursor_temp_100_2.csv') #need to trun the final edit insto a csv readable file. currently in MAT
#%%
...
#%%
store010 = measureDistFromPlane('C:/Users/Li/Desktop/git/tomographyscripts_lchan/particle_final_edit_1k.csv','cursor_temp_010_2.csv') #added _2 to the csv to not overwrite 20220118 sample data
#%%
defaultPixelSize = 0.095*4

comLayer[:,5] = layerClustering(defaultPixelSize,12,6.5,-1455, store010)
...
# Saving Layerization Figure 
figureloc ="./figs/"
plt.savefig(figureloc+'layerization_010_2.png') #there is no figure loc here so im not sure what to put in to save figure since itds in layerizationPart2
plt.show()
#%%
store001 = measureDistFromPlane('C:/Users/Li/Desktop/git/tomographyscripts_lchan/particle_final_edit_1k.csv','cursor_temp_001_20210915.csv', z_buffer =-500) #needs to be reselected in MAT
#%%
comLayer[:,6] = layerClustering(defaultPixelSize, 12, 6.5, -788, store001)
...
plt.show()
#%%
store011 = measureDistFromPlane('C:/Users/Li/Desktop/git/tomographyscripts_lchan/particle_final_edit_1k.csv','cursor_temp_011_2.csv') #needs to be reselected in MAT!!!!
#%%
comLayer[:,7] = layerClustering(defaultPixelSize, 17, 6.5/np.sqrt(2), -1750, store011)
